...
require (
	github.com/Netflix/titus-controllers-api v0.0.17
	github.com/Netflix/titus-kube-common v0.31.0
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.22.11-rc.0
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.22.11-rc.0
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.22.10
	k8s.io/sample-controller => k8s.io/sample-controller v0.22.10
)
